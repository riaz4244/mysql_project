...
select c.customer_id as customer_id, c.first_name as first_name, c.last_name as last_name, ba.artist_name as artist_name, 
...
select * from customter_country where row_no=1;
